...
+ \frac{1}{r^3 \rho } \pdv{}{r} \qty(\Gamma_1 P r^{4} \pdv{\zeta }{r})  \\
\sigma^2 \eta  &= \hlc{green}{-\frac{\eta }{\rho r} \pdv{}{r} \qty(3 \Gamma_1 P - 4P )} \hlc{blue}{- \frac{1}{r^{4} \rho } \pdv{}{r} \qty(\Gamma_1 P r^{4} \pdv{\zeta }{r})}
\,,
\end{align}
%
...
By the first condition, we need the term 
%
\begin{align}
\hlc{blue}{\frac{1}{r^4 \rho } \pdv{}{r} \qty(\Gamma_1 P r^{4} \pdv{\zeta }{r})}
= \frac{\Gamma_1 P}{\rho } \pdv[2]{\zeta }{r}
+ 4 \frac{\Gamma_1 P}{\rho r} \pdv{\zeta}{r} 
+ \frac{\Gamma_1 }{\rho } \pdv{\zeta }{r} \pdv{P}{r}
+ \frac{P}{\rho } \pdv{\zeta }{r} \pdv{\Gamma_1}{r}
\,
\end{align}
%
to be well behaved at \(r=0\). 
