...
We label solutions by \emph{radial order} \(m \in \N\): \(m=0\) has the lowest frequency, and then we have overtones.
...
\begin{equation}
  \expval{\dv{W}{t}}_\Pi = \frac{1}{\Pi} \int_\Pi \int_M   P \pdv{}{t} \frac{1}{\rho} \dd{m} \dd{t}
\end{equation}
...
In a PV diagram, we can see that these correspond to right and left oriented loops.
