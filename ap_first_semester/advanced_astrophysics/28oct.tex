...
\todo[inline]{Not \SI{.1}{\percent}, as the slides say!}
...
\todo[inline]{Is this actually the case? it is not mentioned in the slides, but it seems to be a natural consequence of the hypothesis.}
