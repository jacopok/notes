...
We describe it with a \emph{velocity law}: \(v(r)\), and physically since the force is always radial we have 
%
\begin{equation}
  \dv{v}{r} > 0
\,
...
\end{equation}
%
where \(\mu \) is the molar mass (?), while \(m_u\) is the atomic unit of mass: \(R = k_B / m_u\).
