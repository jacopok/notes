...
There is a dropbox folder with notes by a student from the previous years \cite[]{Pacciani:2018}.
Also, there are handwritten notes by the professor.

There are many good textbooks, for example ``Cosmology'' by Lucchin and Coles \cite[]{LucchinColes:2002}.

% On the astroparticle side, there is another book: I did not catch its name.

The exam is a traditional oral exam, there are fixed dates but they do not matter: on an individual basis we should write an email to set a date and time.
