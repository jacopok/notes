...
\todo[inline]{Ricordati di mettere la referenza al paragrafo della nucleosintesi quando lo sistemerai, che sarebbe carino}, gives the following bounds for the baryonic energy density: 
%
\begin{equation}
...
\end{lstlisting}
\todo[inline]{gives \SI{4.6e-34}{g / cm^3}: it is very close to the figure of 4.8 given in \cite{Pacciani:2018}, but I do not see where the discrepancy would come from.}
...
\todo[inline]{Qui pure sarebbe carino mettere la ref alla sezione} that if neutrinos were massless, their temperature would be \(T_\nu = (4/11)^{1/3} T_\gamma < T_\gamma \).
...
We will show
\todo[inline]{Idem sarebbe bella la ref al punto dove viene dimostrato} that the redshift can be found from the ratio of the scale factors now and at emission: \(1+z = a_0/ a_e\).
Therefore, \(\nu_o / \nu_e = a_e / a_0\).
