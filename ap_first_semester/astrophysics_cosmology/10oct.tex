...
Now, the dimensions of this constant are those of a speed, therefore we can express it as \(C / r^2 = -k_N = -k c^2\), where \(k\) is dimensionless --- we are allowed to do this since \(k_N\) has the dimensions of an energy per unit mass, or equivalently a velocity squared.
