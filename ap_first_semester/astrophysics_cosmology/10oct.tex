...
An article by Zhuang and Yi \cite{zhangCOMMONMISUNDERSTANDINGBIRKHOFF2012} actually claims that this is false, and that the metric inside the shell is indeed a slice of Schwarzschild spacetime but not necessarily with \(M=0\), and their reasoning seems to make sense.}
