...
\section{A Newtonian derivation of the Friedmann equations} \label{sec:friedmann-equations-newtonian}
...
% \todo[inline]{It is claimed in \cite[]{paccianiAppuntiCorsoPhysical2018} that it is a corollary of the  JB theorem that the metric inside a spherical shell is Minkowski, this was not obvious to me so I looked for a reference. 
