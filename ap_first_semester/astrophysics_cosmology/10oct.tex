...
To start with, in General Relativity we cannot directly compare velocities of objects which are far away from each other: they lie in different vector spaces, and there can be no local inertial frame extending that far.
