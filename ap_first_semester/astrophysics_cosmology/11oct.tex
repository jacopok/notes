...
\todo[inline]{This is referred to in the Pacciani notes \cite[page 19]{Pacciani:2018} as the ``adiabatic speed of sound'', but it is not really clear how this derivative is computed for an adiabatic transformation, and even whether it makes sense to approximate perturbations in cosmology as adiabatic.} 
...
\todo[inline]{It is not clear to me how we would derive the EOS for spatial curvature.}
...
\end{align}
%
\todo[inline]{Show that in this case \(q = 1/2\).}
