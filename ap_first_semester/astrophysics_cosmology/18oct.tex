...
This formula is covariant: it only holds in the rest frame of the fluid: this is not an issue, neither are the other formulas in this section. 

\todo[inline]{Explain better why it is covariant.}
