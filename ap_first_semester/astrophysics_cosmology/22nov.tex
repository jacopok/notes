...
\end{enumerate}
\todo[inline]{\textcite[]{paccianiAppuntiCorsoPhysical2018} writes that in the coupled case the comoving density is constant, but this will not be the case in general: allowed annihilation processes may change over time, as other particle species decouple!}
...
\todo[inline]{\textcite[]{paccianiAppuntiCorsoPhysical2018} writes \num{.3}, am I getting the calculation wrong?}
