...
\,,
\end{equation}
\todo[inline]{Do we get it? cannot get the calculation to work out}
%
...
%
\begin{align}
P(T) = \frac{g}{6 \pi^2} \int \dd{q} q^{4} \frac{f(q)}{m + \frac{q^2}{2m}} \approx n(T) T
\,,
\end{align}
%
% GOT HERE, finish calculation
