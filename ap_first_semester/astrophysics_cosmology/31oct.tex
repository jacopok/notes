...
If we integrate from the beginning of time to now, we get the spatial (current) distance elapsed by a photon which started moving at the start of time. This is the radius of the largest region we could in principle observe. It is of the order of \SI{3}{\giga\parsec}.
