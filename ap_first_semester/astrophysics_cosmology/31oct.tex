...
We do not know what \(w _{\text{inf}}\) is besides it being smaller than \(- 1/3\); let us say that it is of the order of \(-1\) like the current dark-energy dominated phase. If we further assume that \(T_f / m_p \sim 1\), we find \(Z _{\text{min}} \sim \num{e30} \approx \exp(70)\). 
...
Now, let us consider the \emph{flatness problem},  which was first proposed by Dick and Peebles in 1986.
