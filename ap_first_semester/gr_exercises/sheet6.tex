...
\begin{align}
  ...
  &= \frac{A^{\prime }}{4B} \qty(\frac{A^{\prime }}{B} + \frac{B^{\prime }}{B} + \frac{A^{\prime}}{A})
  \,,
\end{align}
\end{subequations}
%
...
%
\begin{align}
  R_{00} = R^{i}_{0i0} = \frac{A^{\prime }}{2B} 
  \qty(\frac{A^{\prime }}{B} + \frac{B^{\prime }}{B} + \frac{A^{\prime}}{A} + \frac{4}{r})
\,.
\end{align}
%
