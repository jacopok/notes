...
\todo[inline]{Is this actually the case? Have to check by writing out the 4-velocity and computing \(\dv*{t}{\tau }\): this way might not be correct.}

The orbit is a geodesic, so a pointlike observer feels no acceleration. 

\subsubsection{Tidal acceleration}

It would be interesting to compute the tidal forces on a human-sized observer, however: it is a difficult computation, but it comes from the geodesic deviation equation: 
%
\begin{align}
