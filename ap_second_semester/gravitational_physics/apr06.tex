...
\end{align}
%
\todo[inline]{The sign of the Rømer effect is different here! Intuitively we should expect the delay \(\Delta_R \) to be \(>0\) when \(\hat{n} \cdot \vec{r} < 0\), since then the Earth is \emph{behind the barycenter}.}
