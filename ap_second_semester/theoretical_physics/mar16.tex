...
\todo[inline]{The coefficient before the term \(\propto \partial_0 A_0 \)is reported by the professor as \(2\), but I and several other people find only one of those terms.}
