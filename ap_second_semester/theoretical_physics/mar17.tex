...
\todo[inline]{The professor states that the NR approximation can only be applied in the first case: however, vanilla QM can deal with the second case, as long as \(V_0 < \omega_{k}\), right? The case \(\omega_{k} - M < V_0 \ll \omega_{k}\) is nonrelativistic quantum tunneling!}
