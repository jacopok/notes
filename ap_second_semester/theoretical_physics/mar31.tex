...
\todo[inline]{There is an extra minus sign due to the odd permutation of indices in the Levi-Civita symbol (thanks Andrea!): this does not change the observable \(\abs{\Sigma }^2\), but it is reported incorrectly in the professor's notes.}
