...
&\overset{?}{=} 16 \qty(\frac{q_e q_p}{k^2})^2
...
\end{align}
%
where we used the facts that \(v_e = \abs{p_e} / \omega_{e}\), and \(k^2= t = -4 \omega_{e}^2 v_e^2 \sin^2 \theta / 2\). 

\todo[inline]{The second-to-last step in the calculation is unclear. How does the sine come out? his second-to-last equation from the bottom seems wrong.}
