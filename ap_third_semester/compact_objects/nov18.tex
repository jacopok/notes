...
%
\begin{align}
\Sigma = \num{5.2} \alpha^{-4/5} M_{16}^{7/10} M^{1/2} R^{-3/4} \SI{}{g / cm^2}
\,.
\end{align}
...
When is this smaller than the free-free opacity? the equation reads 
%
\begin{align}
...
For a white dwarf, this is indeed the case; we can tell in general that for \(R \lesssim \SI{e8}{cm}\) electron scattering dominates.
...
So, we will have three regions: going outwards, there is domination of electron scattering, free-free absorption, bound-free/bound-bound absorption. 
...
%
\begin{align}
R  _{\text{equality}} \approx \num{24} \alpha^{2/21} M_{16}^{16/21} f^{9/21} \SI{}{km}
\,.
\end{align}
...
%
\begin{align}
H &= \frac{3}{4} \frac{2GM}{R _{\text{in}}c^2} R _{\text{in}} \frac{\dot{M}}{\dot{M} _{\text{Edd}}} f  \\
&= \frac{3}{4} \eta R _{\text{in}} \frac{\dot{M}}{\dot{M} _{\text{Edd}}} f
\,,
\end{align}
%
so 
%
\begin{align}
\frac{H}{R _{\text{in}}} = \frac{3}{4} \frac{\dot{M}}{\dot{M} _{\text{crit}}} f
\,,
\end{align}
%
and we can see that \(H < R _{\text{in}}\) iff \(\dot{M} < M _{\text{crit}}\). 
Then, we see that the accretion rate must be subcritical as long as we want to keep the disk thin. 
...
%
\begin{align}
T(R) = T _{\text{in}} \qty( \frac{R _{\text{in}}}{R})^{3/2}
\,.
\end{align}
...
The opposite, high energy limit yields an exponential cutoff: 
%
\begin{align}
F_\nu \propto \nu^3 \exp(- \frac{h \nu }{k_B T _{\text{in}}})
\,.
...
\end{align}
%
so \(R \propto x^{4/3} \nu^{-4/3}\), while \(\dd{R} \propto x^{1/3} \propto \nu^{-4/3}\) 
%
\begin{align}
...
The \(F \propto \nu^{1/3}\) signature is a characteristic of accretion disks.  
