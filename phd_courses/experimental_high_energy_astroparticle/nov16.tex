...
% The value of \(p^{*}\) is fixed: we know \(\gamma_m^* = E^{*}_m / m\), and the corresponding value for \(\beta _m^*\) is readily computed as \(\beta _m^* = \sqrt{ 1 - 1 / \gamma _m^*}\). Then, we will have \(p^{*}_m = \beta_m^* \gamma _m^* m\). 

% With all this, the energy \(E_m\) in the lab frame reads 
% %
% \begin{align}
% E_m = \gamma _{\text{CoM}} \gamma_m^* m - \gamma _{\text{CoM}} \beta _{\text{CoM}} \gamma_m^* \beta _m^* m
% \,,
% \end{align}
% %
